...
/// Jobs list provider
final jobsListProvider = StateNotifierProvider<JobsListNotifier, JobsListState>(
  (ref) {
...
class ConversionController extends StateNotifier<void> {
  ...
  Future<Job> convertImagesToPdf(
    List<String> pathsOrIds, [
...
final conversionProvider = StateNotifierProvider<ConversionController, void>((
  ref,
) {
