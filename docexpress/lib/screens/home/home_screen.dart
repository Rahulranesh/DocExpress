...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  void initState() {
    super.initState();
    // ✅ FIXED: Use addPostFrameCallback to delay provider modification
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  // ✅ FIXED: Add bottom padding for FAB (reduced from 100 to 80)
  ...
  // ✅ FIXED: Storage stats with proper spacing and overflow handling
  Widget _buildStorageStats(BuildContext context) {
    ...
    return fileStatsAsync.when(
        ...
        return AppCard(
          child: Column(
            ...
            children: [
              ...
              const Divider(),
              const SizedBox(height: 12),
              // ✅ FIXED: Changed from spaceAround to spaceBetween and wrapped items in Expanded
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Expanded(
      ...
      loading:
          () => ShimmerLoading(height: 160, borderRadius: AppTheme.radiusMd),
      error:
          (error, stack) => AppCard(
            child: Row(
              children: [
...
class _JobListItem extends StatelessWidget {
  ...
  const _JobListItem({required this.job, this.onTap});
...
// ✅ FIXED: StatItem with proper overflow handling
class _StatItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      mainAxisSize: MainAxisSize.min, // ✅ FIXED: Prevent vertical overflow
      children: [
